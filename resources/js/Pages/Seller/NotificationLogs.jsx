...
export default function NotificationLogs({ logs, raffles, filters }) {
    ...
    return (
        <AuthenticatedLayout header="Mis Notificaciones">
            ...
            <div className="space-y-6">
                ...
                {logItems.length > 0 ? (
                    ...
                    <div className="text-center py-16 bg-white rounded-2xl border border-slate-200/60">
                        ...
                        <p className="text-sm text-slate-400">Las notificaciones apareceran aqui cuando vendas boletos</p>
                    </div>
                )}
            </div>
