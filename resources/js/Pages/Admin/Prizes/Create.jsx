...
export default function Create({ raffles }) {
    const { data, setData, post, processing, errors } = useForm({
        raffle_id: raffles.length > 0 ? raffles[0].id : '',
        name: '',
        description: '',
        image: null,
        sort_order: 0,
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('prizes.store'), {
            forceFormData: true,
        });
    };

    return (
        <AuthenticatedLayout header="Nuevo Premio">
            <Head title="Nuevo Premio" />
                    ...
                    <form onSubmit={submit} className="space-y-5">
                        ...
                        <div className="flex items-center gap-3 pt-4 border-t border-slate-100">
                            <button type="submit" disabled={processing}
                                ...
                                {processing ? 'Guardando...' : 'Crear Premio'}
                            </button>
