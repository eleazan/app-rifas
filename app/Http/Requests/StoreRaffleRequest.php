...
class StoreRaffleRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'paella_total'    => ['nullable', 'integer', 'min:1', Rule::requiredIf(fn () => !empty($this->paella_price))],
            'paella_price'    => ['nullable', 'numeric', 'min:0.01', Rule::requiredIf(fn () => !empty($this->paella_total))],
            'paella_deadline' => 'nullable|date',
